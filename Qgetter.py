...
introduction = 'This program can get QQ headimages ,nicknames and headimages of\
 groups with a known QQ ID or GROUP ID.\n\
This program is based on the open Tencent™ QQ headimage and nickname API interf\
ace.\n\
Execute Qgetter(.exe) -h or Qgetter(.exe) --help to view help information.\n\
Execute Qgetter(.exe) without any options to view this introduction.\n\
Note: If U did not get a satisfactory result, please check your QQ ID or GROUP \
ID, or correct grammar..\n\
--Written by Sun Xiao\n'
...
def parseOpts():
	...
	parser.add_argument('-g', '--grammar', required=False, 
		help='Show the right grammar.')
...
if (mode, id_, save) == (None, None, None):
	# Show the program introduction.
	print(introduction)
	os._exit(0)
